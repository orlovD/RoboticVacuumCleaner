#include "_321892366_A.h"

// this should be a global line in _321892366_A.cpp
REGISTER_ALGORITHM (_321892366_A)

//constructor
_321892366_A::_321892366_A() : SmartAlgorithm(){}

// step is called by the simulation for each time unit
Direction _321892366_A::step(Direction prevStep) { //decide where to go depending on the sensor's info
...
//			increaseStepsToDocking();
	...
	if (getMode() == RETURN_TO_UNEXPLORED) {
		...
		//if arrived to closest unexplored point
			...
			getNewUnexploredDirection3(sensor_information, prevStep, available_directions);
		}
