#include "_321892366_B.h"

// this should be a global line in _321892366_B.cpp
REGISTER_ALGORITHM (_321892366_B)

//constructor
_321892366_B::_321892366_B() : SmartAlgorithm(){}

// step is called by the simulation for each time unit
Direction _321892366_B::step(Direction prevStep) { //decide where to go depending on the sensor's info
...
//			increaseStepsToDocking();
	...
	if (getMode() == RETURN_TO_UNEXPLORED) {
		...
		//if arrived to closest unexplored point
			...
			getNewUnexploredDirection2(sensor_information, prevStep, available_directions);
		}
